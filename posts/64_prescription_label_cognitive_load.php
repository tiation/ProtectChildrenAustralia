<?php
/**
 * Blog Post: Prescription Labels &amp; Cognitive Load Theory 💊🧠
 * Generated from: 64_prescription_label_cognitive_load.html
...
$pageTitle = 'Prescription Labels &amp; Cognitive Load Theory 💊🧠';
$pageDescription = 'Prescription Labels &amp; Cognitive Load Theory 💊🧠 💊 Parents juggle dosing schedules, meal prep, work emails—**intrinsic cognitive load** high.';
$postSlug = 'prescription-label-cognitive-load';
...
<h1>Prescription Labels &amp; Cognitive Load Theory 💊🧠</h1>
<p>💊 Parents juggle dosing schedules, meal prep, work emails—**intrinsic cognitive load** high.</p>
<p>- Use color‑coded pill organizers to reduce **extraneous load**.  <br>- Convert mg/kg math to fixed charts on fridge.</p>
<p>Less mental juggling = fewer med errors.</p>
                </div>
