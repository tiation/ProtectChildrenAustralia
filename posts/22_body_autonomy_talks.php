<?php
/**
 * Blog Post: Talking Body Autonomy Without Fearmongering 🗣️🛡️
 * Generated from: 22_body_autonomy_talks.html
 * Category: general
 */
...
$pageTitle = 'Talking Body Autonomy Without Fearmongering 🗣️🛡️';
$pageDescription = 'Talking Body Autonomy Without Fearmongering 🗣️🛡️ 🗣️ Kids need language, not nightmares.';
$postSlug = 'body-autonomy-talks';
...
<h1>Talking Body Autonomy Without Fearmongering 🗣️🛡️</h1>
<p>🗣️ Kids need language, not nightmares.</p>
<p>### Conversation Starters 🌀<br>- “Your body, your rules” ✋.  <br>- Replace “secret” with “surprise”—secrets can hurt, surprises are revealed 🎁.  <br>- Teach correct names: *penis*, *vulva*—clarity empowers.</p>
<p>📚 Use picture books featuring consent to normalize the topic without drama.</p>
                </div>
