<?php
/**
 * Blog Post: Hot Tap, Cold Reality: Setting Water Heaters to Child‑Safe Temperatures 🌡️🚰
 * Generated from: 16_hot_tap_cold_reality.html
...
$pageTitle = 'Hot Tap, Cold Reality: Setting Water Heaters to Child‑Safe Temperatures 🌡️🚰';
$pageDescription = 'Hot Tap, Cold Reality: Setting Water Heaters to Child‑Safe Temperatures 🌡️🚰 🌡️ Water at 60 °C can cause third‑degree burns in 3 seconds.';
$postSlug = 'hot-tap-cold-reality';
...
<h1>Hot Tap, Cold Reality: Setting Water Heaters to Child‑Safe Temperatures 🌡️🚰</h1>
<p>🌡️ Water at 60 °C can cause third‑degree burns in 3 seconds.</p>
<p>### Quick Fix 🔧<br>1. Locate heater thermostat (usually in garage or linen closet).  <br>2. Dial down to **≤ 49 °C** 🔄.  <br>3. Test at the tap with kitchen thermometer 🌡️.</p>
<p>🛁 Add anti‑scald valves on shower mixers for extra insurance.</p>
                </div>
