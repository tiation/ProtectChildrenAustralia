<?php
/**
 * Blog Post: Safe Screen Time: Autonomy‑Supportive Monitoring via Self‑Determination Theory 📱🛡️
 * Generated from: 79_safe_screen_time_sdt.html
...
$pageTitle = 'Safe Screen Time: Autonomy‑Supportive Monitoring via Self‑Determination Theory 📱🛡️';
$pageDescription = 'Safe Screen Time: Autonomy‑Supportive Monitoring via Self‑Determination Theory 📱🛡️ 📱 SDT posits autonomy, competence, relatedness fuel motivation';
$postSlug = 'safe-screen-time-sdt';
...
<h1>Safe Screen Time: Autonomy‑Supportive Monitoring via Self‑Determination Theory 📱🛡️</h1>
<p>📱 SDT posits autonomy, competence, relatedness fuel motivation.</p>
<p>- Let child choose *which* 30‑min educational app (autonomy).  <br>- Set achievable screen‑free challenge badges (competence).  <br>- Co‑watch and discuss content (relatedness).</p>
<p>Collaborative rules outlast coercive bans.</p>
                </div>
