<?php
/**
 * Blog Post: Sleepovers &amp; Cyber‑Predators: Applying Social Learning Theory 🛌📲
 * Generated from: 67_sleepovers_social_learning.html
...
$pageTitle = 'Sleepovers &amp; Cyber‑Predators: Applying Social Learning Theory 🛌📲';
$pageDescription = 'Sleepovers &amp; Cyber‑Predators: Applying Social Learning Theory 🛌📲 🛌 Kids model peers: if friend hides phone under pillow at 2 AM, expectancy nor';
$postSlug = 'sleepovers-social-learning';
...
<h1>Sleepovers &amp; Cyber‑Predators: Applying Social Learning Theory 🛌📲</h1>
<p>🛌 Kids model peers: if friend hides phone under pillow at 2 AM, expectancy normalizes.</p>
<p>#### Mitigation<br>- Pre‑sleepover chat using **if‑then** plans (“If someone shows scary video, I’ll call you”).  <br>- Bedtime tech drop‑box outside room.</p>
<p>Social norms shift; create safer counter‑norms.</p>
                </div>
