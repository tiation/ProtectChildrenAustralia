<?php
/**
 * Blog Post: Emotional Literacy: Teaching Kids to Name Feelings to Prevent Harm 🗣️💡
 * Generated from: 61_emotional_literacy.html
...
$pageTitle = 'Emotional Literacy: Teaching Kids to Name Feelings to Prevent Harm 🗣️💡';
$pageDescription = 'Emotional Literacy: Teaching Kids to Name Feelings to Prevent Harm 🗣️💡 🗣️ **Emotion‑coaching** (Gottman, 1997) shows that children who can label';
$postSlug = 'emotional-literacy';
...
<h1>Emotional Literacy: Teaching Kids to Name Feelings to Prevent Harm 🗣️💡</h1>
<p>🗣️ **Emotion‑coaching** (Gottman, 1997) shows that children who can label feelings manage impulses better—a protective factor against risky behavior.</p>
<p>### Five‑Step Model<br>1. *Notice* emotion cues (frowns, clenched fists).  <br>2. *See* emotion as teachable moment.  <br>3. *Listen* with empathy.  <br>4. *Help label*: “You look frustrated.”  <br>5. *Problem‑solve* together.</p>
<p>🎨 We use a magnet mood board; kids move their face icon under Joy, Sad, Mad, Scared, or Tired.</p>
<p>Skill today, safety tomorrow.</p>
                </div>
