<?php
/**
 * Blog Post: Allies in Autism: Building a Multidisciplinary Support Team 🤝🧩
 * Generated from: 48_allies_in_autism.html
 * Category: education
 */
...
$pageTitle = 'Allies in Autism: Building a Multidisciplinary Support Team 🤝🧩';
$pageDescription = 'Allies in Autism: Building a Multidisciplinary Support Team 🤝🧩 🤝 OT + Speechie + Psych = progress triangle.';
$postSlug = 'allies-in-autism';
...
<h1>Allies in Autism: Building a Multidisciplinary Support Team 🤝🧩</h1>
<p>🤝 OT + Speechie + Psych = progress triangle.</p>
<p>- Join local ASD parent WhatsApp for therapist reviews.  <br>- Rotate appointment days to avoid school burnout.  <br>- Share goals across providers so everyone rows same direction.</p>
<p>It takes a village; choose villagers wisely.</p>
                </div>
