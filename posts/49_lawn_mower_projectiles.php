<?php
/**
 * Blog Post: Lawn Mowers and Loose Toys: Preventing Backyard Projectiles 🏡🌀
 * Generated from: 49_lawn_mower_projectiles.html
 * Category: general
 */
...
$pageTitle = 'Lawn Mowers and Loose Toys: Preventing Backyard Projectiles 🏡🌀';
$pageDescription = 'Lawn Mowers and Loose Toys: Preventing Backyard Projectiles 🏡🌀 🏡 Tiny stones + spinning blades = 300 km/h shrapnel.';
$postSlug = 'lawn-mower-projectiles';
...
<h1>Lawn Mowers and Loose Toys: Preventing Backyard Projectiles 🏡🌀</h1>
<p>🏡 Tiny stones + spinning blades = 300 km/h shrapnel.</p>
<p>- Walk yard first; pick up sticks &amp; toys.  <br>- Fit mower with rear guard flap.  <br>- Kids watch from inside—window closed.</p>
<p>Weekly chore, lifelong vision saved.</p>
                </div>
