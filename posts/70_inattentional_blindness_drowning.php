<?php
/**
 * Blog Post: Silent Drowning &amp; Inattentional Blindness 👁️🌊
 * Generated from: 70_inattentional_blindness_drowning.html
...
$pageTitle = 'Silent Drowning &amp; Inattentional Blindness 👁️🌊';
$pageDescription = 'Silent Drowning &amp; Inattentional Blindness 👁️🌊 👁️ Simons &amp; Chabris’ Gorilla study shows we miss unexpected events while focused elsewhere.';
$postSlug = 'inattentional-blindness-drowning';
...
<h1>Silent Drowning &amp; Inattentional Blindness 👁️🌊</h1>
<p>👁️ Simons &amp; Chabris’ Gorilla study shows we miss unexpected events while focused elsewhere.</p>
<p>Apply: counting pool noodles = missing submerged child.</p>
<p>Use **scanning pattern**: left‑to‑right, near‑to‑far, surface‑to‑bottom every 10 seconds.</p>
<p>Training attention beats hoping perception.</p>
                </div>
