<?php
/**
 * Blog Post: Cutlery, Cords, and Chemicals: A Room‑by‑Room Hazard Audit 🔪🔌🧴
 * Generated from: 12_cutlery_cords_chemicals.html
...
$pageTitle = 'Cutlery, Cords, and Chemicals: A Room‑by‑Room Hazard Audit 🔪🔌🧴';
$pageDescription = 'Cutlery, Cords, and Chemicals: A Room‑by‑Room Hazard Audit 🔪🔌🧴 🔍 **Mission:** Find hidden dangers before tiny hands do.';
$postSlug = 'cutlery-cords-chemicals';
...
<h1>Cutlery, Cords, and Chemicals: A Room‑by‑Room Hazard Audit 🔪🔌🧴</h1>
<p>🔍 **Mission:** Find hidden dangers before tiny hands do.</p>
<p>### Kitchen 🍳<br>- Magnetic knife strips **above backsplash**.  <br>- Child‑proof latches on lower cabinets 🔒.  </p>
<p>### Living Room 🛋️<br>- Anchor TVs &amp; bookshelves 📚.  <br>- Wrap blind cords with cleats ⚓.  </p>
<p>### Bathroom 🚿<br>- Lock cleaners in high cupboard 🧼🔑.  <br>- Store hair straighteners on heat‑proof hook ♨️.  </p>
<p>### Garage 🛠️<br>- Antifreeze high &amp; locked 🐾.  <br>- Tool key stored separately 🗝️.</p>
<p>Turn auditing into a quarterly family scavenger hunt—prizes for most hazards found!</p>
                </div>
