<?php
/**
 * Blog Post: Cognitive Dissonance in Family Safety Talks 🧠💬
 * Generated from: 98_cognitive_dissonance_safety.html
 * Category: parenting
 */
...
$pageTitle = 'Cognitive Dissonance in Family Safety Talks 🧠💬';
$pageDescription = 'Cognitive Dissonance in Family Safety Talks 🧠💬 🧠 Festinger: discomfort when beliefs clash. Grandpa says gates unnecessary; evidence says otherwise.';
$postSlug = 'cognitive-dissonance-safety';
...
<h1>Cognitive Dissonance in Family Safety Talks 🧠💬</h1>
<p>🧠 Festinger: discomfort when beliefs clash.</p>
<p>Grandpa says gates unnecessary; evidence says otherwise.</p>
<p>Tactic: **foot‑in‑the‑door**—first ask to *inspect* gate together, then suggest latch upgrade. Small agreement paves way for bigger change.</p>
                </div>
