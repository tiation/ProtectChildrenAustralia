<?php
/**
 * Blog Post: The Daycare Tour: Questions I Never Thought to Ask 🏫🔍
 * Generated from: 91_daycare_tour_questions.html
...
$pageTitle = 'The Daycare Tour: Questions I Never Thought to Ask 🏫🔍';
$pageDescription = 'The Daycare Tour: Questions I Never Thought to Ask 🏫🔍 🏫 Touring centres used to be about pastel walls and playground slides.';
$postSlug = 'daycare-tour-questions';
...
<h1>The Daycare Tour: Questions I Never Thought to Ask 🏫🔍</h1>
<p>🏫 Touring centres used to be about pastel walls and playground slides. Post-accident, my checklist is surgical.</p>
<p>### Non‑Negotiable Questions<br>1. **Water policy**: Any buckets left out for cleaning?  <br>2. **Staff‑to‑child ratio** at water tables.  <br>3. **CPR certification**—show me evidence, not promises.  <br>4. **Bathroom supervision** procedures (two‑adult rule?).  <br>5. **Door alarms** on playground gates?</p>
<p>Asking feels awkward; regret feels worse.</p>
                </div>
