<?php
/**
 * Blog Post: Pedophiles in Plain Sight: Vetting Family Friends and “Safe” Adults 🕵️‍♂️🚧
 * Generated from: 11_pedophiles_in_plain_sight.html
 * Category: parenting
 */
...
$pageTitle = 'Pedophiles in Plain Sight: Vetting Family Friends and “Safe” Adults 🕵️‍♂️🚧';
$pageDescription = 'Pedophiles in Plain Sight: Vetting Family Friends and “Safe” Adults 🕵️‍♂️🚧 🕵️‍♂️ **Hard Truth:** 90 % of child abuse is committed';
$postSlug = 'pedophiles-in-plain-sight';
...
<h1>Pedophiles in Plain Sight: Vetting Family Friends and “Safe” Adults 🕵️‍♂️🚧</h1>
<p>🕵️‍♂️ **Hard Truth:** 90 % of child abuse is committed by someone the family already knows.</p>
<p>### Vetting Checklist ✅<br>- **Background checks** through local police 👮‍♀️.  <br>- Ask for **two childcare references** not related to them 📝.  <br>- Observe **boundary respect**: do they ask permission before hugging? 🤗</p>
<p>### Layered Supervision 🪄<br>- Devices stay in **public rooms** only.  <br>- Install **door‑ajar alarms** on bedrooms 🚪🔔.  <br>- Use a rotating “safe word” for pick‑ups 🗝️.</p>
<p>🚩 **Red Flags**  <br>1. Insists on one‑on‑one outings.  <br>2. Excessive gift‑giving 🎁.  <br>3. Undermines your rules.</p>
<p>Trust your gut; investigate your gut feelings with facts.</p>
                </div>
