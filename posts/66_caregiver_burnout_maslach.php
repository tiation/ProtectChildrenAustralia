<?php
/**
 * Blog Post: Recognizing Burn‑Out in Special‑Needs Parenting 🛠️🩹
 * Generated from: 66_caregiver_burnout_maslach.html
 * Category: parenting
 */
...
$pageTitle = 'Recognizing Burn‑Out in Special‑Needs Parenting 🛠️🩹';
$pageDescription = 'Recognizing Burn‑Out in Special‑Needs Parenting 🛠️🩹 🛠️ **Maslach Burnout Inventory** flags: Emotional Exhaustion, Depersonalization, Low Person';
$postSlug = 'caregiver-burnout-maslach';
...
<h1>Recognizing Burn‑Out in Special‑Needs Parenting 🛠️🩹</h1>
<p>🛠️ **Maslach Burnout Inventory** flags: Emotional Exhaustion, Depersonalization, Low Personal Accomplishment.</p>
<p>Checklist:  <br>- Dread therapy appointments?  <br>- Snappy at innocuous questions?  <br>- Forgot last time you laughed?</p>
<p>🔄 Rotate respite care, join peer groups—social support counters cortisol load (Sapolsky).</p>
                </div>
