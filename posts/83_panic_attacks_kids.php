<?php
/**
 * Blog Post: Recognizing Panic Attacks in Kids After Trauma: Polyvagal Lens 🫀🌀
 * Generated from: 83_panic_attacks_kids.html
...
$pageTitle = 'Recognizing Panic Attacks in Kids After Trauma: Polyvagal Lens 🫀🌀';
$pageDescription = 'Recognizing Panic Attacks in Kids After Trauma: Polyvagal Lens 🫀🌀 🫀 Polyvagal Theory: shutdown, fight/flight, social engagement.';
$postSlug = 'panic-attacks-kids';
...
<h1>Recognizing Panic Attacks in Kids After Trauma: Polyvagal Lens 🫀🌀</h1>
<p>🫀 Polyvagal Theory: shutdown, fight/flight, social engagement.</p>
<p>Signs: blank stare ➡️ sudden hyperactivity ➡️ clingy.</p>
<p>- Grounding exercise: 5-4-3-2-1 senses.  <br>- Teach belly breathing with bubble wands.</p>
<p>Regulate body, mind follows.</p>
                </div>
