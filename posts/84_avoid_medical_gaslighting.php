<?php
/**
 * Blog Post: Avoiding Medical Gaslighting: Heuristics &amp; Bias Awareness 🏥🔍
 * Generated from: 84_avoid_medical_gaslighting.html
 * Category: general
 */
...
$pageTitle = 'Avoiding Medical Gaslighting: Heuristics &amp; Bias Awareness 🏥🔍';
$pageDescription = 'Avoiding Medical Gaslighting: Heuristics &amp; Bias Awareness 🏥🔍 🏥 Doctors are human—subject to **anchoring** and **confirmation** bias.';
$postSlug = 'avoid-medical-gaslighting';
...
<h1>Avoiding Medical Gaslighting: Heuristics &amp; Bias Awareness 🏥🔍</h1>
<p>🏥 Doctors are human—subject to **anchoring** and **confirmation** bias.</p>
<p>Strategies:  <br>- Lead with timeline, not theory.  <br>- Ask, “What else could this be?” to trigger differential thinking.  <br>- Bring a second adult witness for note accuracy.</p>
<p>Data trumps deference.</p>
                </div>
