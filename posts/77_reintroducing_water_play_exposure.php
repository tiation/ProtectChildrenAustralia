<?php
/**
 * Blog Post: Reintroducing Water Play After Loss: Exposure Therapy Principles 💧🛤️
 * Generated from: 77_reintroducing_water_play_exposure.html
...
$pageTitle = 'Reintroducing Water Play After Loss: Exposure Therapy Principles 💧🛤️';
$pageDescription = 'Reintroducing Water Play After Loss: Exposure Therapy Principles 💧🛤️ 💧 Gradual exposure reduces avoidance and anxiety (Foa &amp; Kozak).';
$postSlug = 'reintroducing-water-play-exposure';
...
<h1>Reintroducing Water Play After Loss: Exposure Therapy Principles 💧🛤️</h1>
<p>💧 Gradual exposure reduces avoidance and anxiety (Foa &amp; Kozak).</p>
<p>- Start with dry water table play.  <br>- Progress to shallow splash pad visits.  <br>- Finally, brief pool entries with trusted adult.</p>
<p>Track distress on 1‑10 scale; advance when rating ≤ 3.</p>
                </div>
