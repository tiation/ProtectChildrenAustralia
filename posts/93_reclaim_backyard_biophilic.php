<?php
/**
 * Blog Post: Reclaiming the Backyard: Biophilic Design for Healing 🌳🪴
 * Generated from: 93_reclaim_backyard_biophilic.html
...
$pageTitle = 'Reclaiming the Backyard: Biophilic Design for Healing 🌳🪴';
$pageDescription = 'Reclaiming the Backyard: Biophilic Design for Healing 🌳🪴 🌳 **Biophilic design** (Kellert) links nature exposure to reduced cortisol.';
$postSlug = 'reclaim-backyard-biophilic';
...
<h1>Reclaiming the Backyard: Biophilic Design for Healing 🌳🪴</h1>
<p>🌳 **Biophilic design** (Kellert) links nature exposure to reduced cortisol.</p>
<p>- Added raised herb beds—child’s name in mosaic tiles.  <br>- Installed bubbling rock fountain; water sound re‑frames trauma.  <br>- Butterfly‑attracting flowers as symbols of transformation 🦋.</p>
<p>Environment becomes therapy when curated with intention.</p>
                </div>
