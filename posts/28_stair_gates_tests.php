<?php
/**
 * Blog Post: Stair Gates: Proper Installation and the Tests You Should Run Weekly 🚪🧪
 * Generated from: 28_stair_gates_tests.html
 * Category: general
 */
...
$pageTitle = 'Stair Gates: Proper Installation and the Tests You Should Run Weekly 🚪🧪';
$pageDescription = 'Stair Gates: Proper Installation and the Tests You Should Run Weekly 🚪🧪 🚪 A loose gate is a false promise.';
$postSlug = 'stair-gates-tests';
...
<h1>Stair Gates: Proper Installation and the Tests You Should Run Weekly 🚪🧪</h1>
<p>🚪 A loose gate is a false promise.</p>
<p>### Installation Musts 🔩<br>- Use **hardware‑mounted** gates for top of stairs—pressure bars alone slip.  <br>- Height: at least ¾ of child’s body 🧒📏.  <br>- Latch opens one‑handed for adults, two‑step for tots 🧤.</p>
<p>🧪 **Weekly Test**: Push with 5 kg force; any wiggle means re‑tighten.</p>
                </div>
