<?php
/**
 * Blog Post: Pool Covers and Risk Compensation Theory 🏊‍♂️🛑
 * Generated from: 69_risk_compensation_pool_covers.html
...
$pageTitle = 'Pool Covers and Risk Compensation Theory 🏊‍♂️🛑';
$pageDescription = 'Pool Covers and Risk Compensation Theory 🏊‍♂️🛑 🏊‍♂️ Installing covers sometimes increases risk—parents subconsciously relax (“Peltzman';
$postSlug = 'risk-compensation-pool-covers';
...
<h1>Pool Covers and Risk Compensation Theory 🏊‍♂️🛑</h1>
<p>🏊‍♂️ Installing covers sometimes increases risk—parents subconsciously relax (“Peltzman effect”).</p>
<p>Solution: treat cover as *additional*, not *primary* layer; keep alarms armed, gates locked, watcher assigned.</p>
<p>Awareness breaks compensation cycle.</p>
                </div>
