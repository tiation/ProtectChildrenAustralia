<?php
/**
 * Blog Post: Shared Custody &amp; Consistent Safety Rules: Systems Theory Approach 💼⚖️
 * Generated from: 85_shared_custody_consistency.html
...
$pageTitle = 'Shared Custody &amp; Consistent Safety Rules: Systems Theory Approach 💼⚖️';
$pageDescription = 'Shared Custody &amp; Consistent Safety Rules: Systems Theory Approach 💼⚖️ 💼 Families are subsystems; consistency prevents boundary confusion.';
$postSlug = 'shared-custody-consistency';
...
<h1>Shared Custody &amp; Consistent Safety Rules: Systems Theory Approach 💼⚖️</h1>
<p>💼 Families are subsystems; consistency prevents boundary confusion.</p>
<p>Create joint Google Doc listing:  <br>- Bedtime, screen limits, pool rules.</p>
<p>Update monthly; conflicts solved in text, not in front of kids.</p>
                </div>
