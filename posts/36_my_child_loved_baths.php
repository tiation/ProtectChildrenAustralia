<?php
/**
 * Blog Post: My Child Loved Baths: Why I Now Drain Tubs Immediately 🛁💔
 * Generated from: 36_my_child_loved_baths.html
 * Category: general
 */
...
$pageTitle = 'My Child Loved Baths: Why I Now Drain Tubs Immediately 🛁💔';
$pageDescription = 'My Child Loved Baths: Why I Now Drain Tubs Immediately 🛁💔 Word count low today because memories are loud. Drain. Wipe tears.';
$postSlug = 'my-child-loved-baths';
...
<h1>My Child Loved Baths: Why I Now Drain Tubs Immediately 🛁💔</h1>
<p>Word count low today because memories are loud.  </p>
<p>Drain.  <br>Wipe tears.  <br>Move on—for the kids who still splash.</p>
<p>**Action**: Pull the plug *before* the towel.</p>
                </div>
