<?php
/**
 * Blog Post: Childhood Nightmares After Trauma: CBT‑I Strategies 🌙😱
 * Generated from: 94_trauma_nightmares_cbt.html
...
$pageTitle = 'Childhood Nightmares After Trauma: CBT‑I Strategies 🌙😱';
$pageDescription = 'Childhood Nightmares After Trauma: CBT‑I Strategies 🌙😱 🌙 Night brings replay reels. **CBT‑I Toolbox** - **Stimulus control**: bed = sleep only.';
$postSlug = 'trauma-nightmares-cbt';
...
<h1>Childhood Nightmares After Trauma: CBT‑I Strategies 🌙😱</h1>
<p>🌙 Night brings replay reels.</p>
<p>**CBT‑I Toolbox**  <br>- **Stimulus control**: bed = sleep only.  <br>- **Imagery rehearsal**: rewrite nightmare ending while awake.  <br>- **Sleep hygiene**: no screens 1 hr before bed, room temp 19 °C.</p>
<p>Consult behavioral sleep specialist if terrors persist beyond 6 weeks.</p>
                </div>
