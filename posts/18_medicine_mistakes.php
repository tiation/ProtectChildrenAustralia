<?php
/**
 * Blog Post: Medicine Mistakes: Lockboxes, Logs, and Label Literacy 💊🔐
 * Generated from: 18_medicine_mistakes.html
...
$pageTitle = 'Medicine Mistakes: Lockboxes, Logs, and Label Literacy 💊🔐';
$pageDescription = 'Medicine Mistakes: Lockboxes, Logs, and Label Literacy 💊🔐 💊 **Poisons can look like candy** to a 3‑year‑old. ### Safety Three‑Pack 🎁1.';
$postSlug = 'medicine-mistakes';
...
<h1>Medicine Mistakes: Lockboxes, Logs, and Label Literacy 💊🔐</h1>
<p>💊 **Poisons can look like candy** to a 3‑year‑old.</p>
<p>### Safety Three‑Pack 🎁<br>1. **Lockbox** with combination only adults know 🔐.  <br>2. **Dosage log** on fridge to avoid double‑dosing ✍️.  <br>3. **Label literacy**—teach teens to read active ingredients 🧾.</p>
<p>Dispose of expired meds during local “drug take‑back” days ♻️.</p>
                </div>
