---
layout: default
title: Protectchildrenaustralia - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Protectchildrenaustralia</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/ProtectChildrenAustralia" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t ProtectChildrenAustralia .

# Run container
docker run -p 8080:8080 ProtectChildrenAustralia
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/ProtectChildrenAustralia)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/ProtectChildrenAustralia/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/ProtectChildrenAustralia/discussions)
